...
#define FFMPEG_CONFIGURATION "--arch=x86 --cpu=i686 --enable-yasm --enable-openssl --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-demuxer=mp3 --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=aasc --enable-decoder=flac --enable-decoder=ac3 --enable-decoder=h264 --enable-decoder=mp1 --enable-decoder=mp1float --enable-decoder=mp2 --enable-decoder=mp2float --enable-decoder=mp3adu --enable-decoder='mp3adufloat--enable-decoder=mp3float--enable-decoder=mp3on4--enable-decoder=mp3on4float--enable-decoder=mpeg4--enable-decoder=mpeg1--enable-decoder=mpeg2--enable-decoder=msmpeg4v2--enable-decoder=msmpeg4v3--enable-decoder=wavpack--enable-decoder=opus--enable-decoder=vorbis--enable-decoder=wmalossless--enable-decoder=wmapro--enable-decoder=wmav1--enable-decoder=wmav2--enable-decoder=wmavoice--enable-encoder=libopus--enable-hwaccel=h264_d3d11va--enable-hwaccel=h264_dxva2--enable-parser=aac--enable-parser=aac_latm--enable-parser=flac--enable-parser=h264--enable-parser=mpeg4video--enable-parser=mpegaudio--enable-parser=opus--enable-parser=vorbis--enable-demuxer=aac--enable-demuxer=ac3--enable-demuxer=flac--enable-demuxer=gif--enable-demuxer=h264--enable-demuxer=mov--enable-demuxer=ogg--enable-demuxer=wav--enable-muxer=ogg--enable-muxer=opus' --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-iconv --enable-protocol=async --disable-linux-perf --prefix=/home/ahmed/Desktop/ahmed/ijkplayer-android/android/contrib/build/ffmpeg-x86/output --cross-prefix=i686-linux-android- --enable-cross-compile --target-os=linux --enable-pic --disable-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/ahmed/Desktop/ahmed/ijkplayer-android/android/contrib/build/openssl-x86/output/include -march=atom -msse3 -ffast-math -mfpmath=sse' --extra-ldflags=' -L/home/ahmed/Desktop/ahmed/ijkplayer-android/android/contrib/build/openssl-x86/output/lib -lssl -lcrypto '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/home/ahmed/Desktop/ahmed/ijkplayer-android/android/contrib/build/ffmpeg-x86/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/ahmed/Desktop/ahmed/ijkplayer-android/android/contrib/build/ffmpeg-x86/output/share/ffmpeg"
